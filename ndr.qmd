...
Questa **versione in HTML** delle linee guida è basata sul **materiale originale** dell'**Agenzia per l'Italia Digitale** (AgID), rilasciato con licenza [**CC-BY 4.0**](https://creativecommons.org/licenses/by/4.0/deed.it).<br>
